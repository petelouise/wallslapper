...
async function transitionToColor(startColor, endColor, duration) {
  ...
  console.log(`Starting transition from ${startColor} to ${endColor} over ${duration}ms`);
...
async function main() {
  try {
    ...
    await transitionToColor(startColor, endColor, 10000); // Reduced duration for testing
    console.log("Done!");
  } catch (error) {
